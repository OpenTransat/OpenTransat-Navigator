//modified for default callibration: 32V/20A, RSHUNT = 0.01 ohm
/**************************************************************************/
/*! 
...
/*! 
    @brief  Configures to INA219 to be able to measure up to 32V and 10A
            of current.  Each unit of current corresponds to 500uA, and
            each unit of power corresponds to 10mW. Counter overflow
            occurs at 16A.
			
    @note   These calculations assume a 0.02 ohm resistor is present
*/
/**************************************************************************/
void Adafruit_INA219::setCalibration_32V_10A(void)
{
  ...
  // MaximumLSB = 0.002441              (2441uA per bit)
  
  // 4. Choose an LSB between the min and max values
  //    (Preferrably a roundish number close to MinLSB)
  // CurrentLSB = 0.0005 (500uA per bit)
  ...
  // Max_Current = 16.3835 before overflow
  //
  ...
  ina219_currentDivider_mA = 2.0;  // Current LSB = 500uA per bit (1000/500 = 2)
...
/**************************************************************************/
/*! 
    @brief  Configures to INA219 to be able to measure up to 32V and 20A
...
void Adafruit_INA219::setCalibration_32V_20A(void)
{
  ...
  // MaximumLSB = MaxExpected_I/4096
  // MaximumLSB = 0.00488              (4880uA per bit)
  ...
  ina219_powerDivider_mW = 2;     // Power LSB = 1?mW per bit (2/1)
...
void Adafruit_INA219::setCalibration_32V_2A(void)
{
  ...
  ina219_powerDivider_mW = 1;     // Power LSB = 2mW per bit (2/2)
